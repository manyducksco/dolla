...
import { createTranslate } from "@manyducks.co/dolla/translate";
...
const translate = createTranslate({
  ...
  // Each locale your app supports should have an entry here.
  // There are two ways to define a translation.
  translations: {
    // An object to supply the keys and translated strings inline.
    en: {
    ...
    // Or a function that fetches and returns your translation object.
    ja: () => fetch("/api/translations/ja").then((res) => res.json()),
  },
});

createRoot(document.body).plugin(translate).mount(App);
```
...
```jsx
import { $translate } from "@manyducks.co/dolla/translate";
